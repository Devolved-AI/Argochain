...
use frame_support::{
	...
	traits::{
		...
		OnUnbalanced, VariantCountOf, WithdrawReasons,Everything,FindAuthor
	},
	weights::{
		constants::{
...
pub const EXISTENTIAL_DEPOSIT: Balance = 1 * ARGO;
...
impl_runtime_apis! {
    ...
    > for Runtime
    {
        fn quote_price_exact_tokens_for_tokens(asset1: NativeOrWithId<u32>, asset2: NativeOrWithId<u32>, amount: u128, include_fee: bool) -> Option<Balance> {
            AssetConversion::quote_price_exact_tokens_for_tokens(asset1, asset2, amount, include_fee)
        }

        fn quote_price_tokens_for_exact_tokens(asset1: NativeOrWithId<u32>, asset2: NativeOrWithId<u32>, amount: u128, include_fee: bool) -> Option<Balance> {
