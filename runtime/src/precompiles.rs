// use pallet_evm::{
//     IsPrecompileResult, Precompile, PrecompileOutput, PrecompileFailure, PrecompileHandle, PrecompileResult, PrecompileSet, ExitRevert, ExitSucceed,
// };
...
//             hash(1024),
//             hash(1025),
//             hash(1026), // Reserved for minting precompile
//         ]
//     }

//     fn execute_mint_precompile(
//         &self,
...
//         let mut account = pallet_evm::Pallet::<R>::account_basic(&evm_address);
//         account.balance = account.balance.saturating_add(amount_to_mint);
//         pallet_evm::Pallet::<R>::mutate_account(evm_address, account);
...
//             a if a == hash(1026) => Some(self.execute_mint_precompile(handle)),
//             _ => None,
//         }
//     }
