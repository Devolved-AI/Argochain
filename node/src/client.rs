...
// Local
use argochain_runtime::{opaque::Block, AccountId, Balance, Nonce};
...
pub type Client = FullClient<argochain_runtime::RuntimeApi, TemplateRuntimeExecutor>;
...
impl NativeExecutionDispatch for TemplateRuntimeExecutor {
	...
	fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
		argochain_runtime::api::dispatch(method, data)
	}

	fn native_version() -> NativeVersion {
		argochain_runtime::native_version()
	}
}
